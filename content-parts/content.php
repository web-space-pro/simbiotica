...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="flex flex-col md:flex-row gap-4 md:gap-16">
        <div class="w-full md:w-6/12 hidden md:block">
        ...
        <div class="w-full md:w-6/12">
            ...
            <div class="w-full md:hidden border-t border-gray-10 pt-5 mt-5">
                <div class="xs:w-1/2 m-auto md:w-full">
                    <?php simbiotica_post_thumbnail(); ?>
                </div>
            </div>

            <div class="max-w-full md:mt-4 pt-5 md:border-t border-gray-10 font-sans *:mb-4">
                <?php the_content(); ?>
            </div>
