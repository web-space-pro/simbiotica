...
<body <?php body_class('antialiased font-reg font-normal bg-white-10 leading-normal text-sm xs:text-base text-black selection:bg-black selection:text-white-10'); ?>>
<?php wp_body_open(); ?>
